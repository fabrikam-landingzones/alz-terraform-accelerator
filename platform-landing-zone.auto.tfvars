...
custom_replacements = {
  ...
  */
  names = {
    ...
    primary_firewall_name                                        = "fw-alz-hub-$${starter_location_01}"
    primary_firewall_policy_name                                 = "fwp-alz-hub-$${starter_location_01}"
    primary_firewall_public_ip_name                              = "pip-fw-alz-hub-$${starter_location_01}"
    primary_firewall_management_public_ip_name                   = "pip-fw-alz-hub-mgmt-$${starter_location_01}"
    primary_route_table_firewall_name                            = "rt-alz-hub-fw-$${starter_location_01}"
    primary_route_table_user_subnets_name                        = "rt-alz-hub-std-$${starter_location_01}"
    primary_virtual_network_gateway_express_route_name           = "vgw-alz-hub-er-$${starter_location_01}"
    primary_virtual_network_gateway_express_route_public_ip_name = "pip-vgw-alz-hub-er-$${starter_location_01}"
    primary_virtual_network_gateway_vpn_name                     = "vgw-alz-hub-vpn-$${starter_location_01}"
    primary_virtual_network_gateway_vpn_public_ip_name_1         = "pip-vgw-alz-hub-vpn-$${starter_location_01}-001"
    primary_virtual_network_gateway_vpn_public_ip_name_2         = "pip-vgw-alz-hub-vpn-$${starter_location_01}-002"
    primary_private_dns_resolver_name                            = "pdr-alz-hub-dns-$${starter_location_01}"
    primary_bastion_host_name                                    = "bas-alz-hub-$${starter_location_01}"
    primary_bastion_host_public_ip_name                          = "pip-bastion-alz-hub-$${starter_location_01}"
